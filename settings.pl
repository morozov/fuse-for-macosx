...
/* The null UI has no user and therefore no preferences: what it runs is
   determined by argv and the media it is given, and it leaves the preferences
   of the interactive Fuse on the same machine alone. */
